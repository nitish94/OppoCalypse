...
replace github.com/pelletier/go-toml/v2 => github.com/pelletier/go-toml/v2 v2.0.5

replace golang.org/x/sys => golang.org/x/sys v0.0.0-20220520151302-bc2c85ada10a
